              ...
              <div class="v25_37">
                <div class="v25_38">
                  <div class="v25_39">
                    ...
                    <div>
                      <input type="text" class="v25_58" value = "<?php echo date($_POST['txtAadhaar']) ?>" readonly />
                    </div>
                    <div class="v25_59">
                      <table class="fl-table">
                        ...
                        <tbody>
                          <?php
                            ...
                            $sql = "SELECT * FROM ticket WHERE `Ticket Aadhaar number` = '$txtAadhaar'";
                    ...
                    <div class="v54_4">
                      <div class="v54_3">
                        <a href="home.php" class="btn1">Submit</a>
                      </div>
                    </div>
                  </div>
                </div>
